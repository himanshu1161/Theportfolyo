                ...
                <ul>
                  <li className="wow fadeInUp" data-wow-duration=".7s">
                    <div className="list_inner">
                      <div className="title">
                        <span>{data?.user?.services[0]?.name}</span>
                      </div>
                      <div className="cost">
                        <span>{data?.user?.services[0]?.charge}</span>
                      </div>
                      <svg
                  ...
                  >
                    <div className="list_inner">
                    <div className="title">
                        <span>{data?.user?.services[1]?.name}</span>
                      </div>
                      <div className="cost">
                        <span>{data?.user?.services[1]?.charge}</span>
                      </div>
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        version="1.1"
                  ...
                  >
                    <div className="list_inner">
                    <div className="title">
                        <span>{data?.user?.services[2]?.name}</span>
                      </div>
                      <div className="cost">
                        <span>{data?.user?.services[2]?.charge}</span>
                      </div>
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        id="_x31__x2C_5"
                  ...
                  >
                    <div className="list_inner">
                    <div className="title">
                        <span>{data?.user?.services[3]?.name}</span>
                      </div>
                      <div className="cost">
                        <span>{data?.user?.services[3]?.charge}</span>
                      </div>
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        version="1.1"
                  ...
                  >
                    <div className="list_inner">
                    <div className="title">
                        <span>{data?.user?.services[4]?.name}</span>
                      </div>
                      <div className="cost">
                        <span>{data?.user?.services[4]?.charge}</span>
                      </div>
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        version="1.1"
